...
const getBackendUrl = () => {
  if (typeof window === "undefined") return import.meta.env.VITE_BACKEND_URL || "http://localhost:4000";
  const h = window.location.hostname;
  if (h === "localhost" || h === "127.0.0.1") return import.meta.env.VITE_BACKEND_URL || "http://localhost:4000";
  if (/^(192\.168\.|10\.|172\.(1[6-9]|2[0-9]|3[0-1])\.)/.test(h)) return `http://${h}:4000`;
